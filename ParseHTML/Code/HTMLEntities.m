...
static int (^ReplacementMapComparator)(const void *voidKey, const void *voidItem) = ^(const void *voidKey, const void *voidItem) {
...
static int (^NamedMapPrefixComparator)(const void *voidKey, const void *voidItem) = ^int(const void *voidKey, const void *voidItem) {
