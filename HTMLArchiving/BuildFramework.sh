...
FRAMEWORK_NAME="HTMLArchiving"
IOS_SUFFIX=""
MAC_SUFFIX=""
CONFIG=$CONFIGURATION
UNIVERSAL_OUTPUTFOLDER="Build/${CONFIG}-universal"
PROJECT_NAME="HTMLArchiving"
...
IOS_PLIST_PATH="${PROJECT_DIR}/HTMLArchiving/iOS/info.plist"
...
MAC_PLIST_PATH="${PROJECT_DIR}/HTMLArchiving/Mac/info.plist"
